...
class CSRFTokenView(APIView):
    # public endpoint to set/get csrf cookie
    ...
    def get(self, request):
        ...
        # set cookie explicitly to ensure browser receives it on cross-origin requests
        resp.set_cookie(
            settings.CSRF_COOKIE_NAME if hasattr(settings, 'CSRF_COOKIE_NAME') else 'csrftoken',
            token,
